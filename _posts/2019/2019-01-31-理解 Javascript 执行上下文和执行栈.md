...
[文章来源](https://juejin.im/post/5bdfd3e151882516c6432c32)
...
注意： 对于函数环境而言，环境记录还包含了一个 arguments 对象，该对象包含了索引和传递给函数的参数之间的映射以及传递给函数的参数的长度（数量）。例如，下面函数的 arguments 对象如下所示：
```
function foo(a, b) {  
  var c = a + b;  
}  
